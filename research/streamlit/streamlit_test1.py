...
if st.session_state.edit_mode:
    edited_df = st.data_editor(st.session_state.df[columns_to_show], key="editor")
    # Update the session state when edits are made
...
# Edit mode controls below the table
...
# Use a container to ensure form updates are processed correctly
with st.container():
